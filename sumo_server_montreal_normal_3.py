...
''' This script runs the simulation in normal conditions but is monitoring 3 junctions. '''
...
def run():
	...
	outputVehicle = "Normal_3/vehicles_around_junction" + junction_ID_1 +junction_ID_2 + junction_ID_3 + str(opt.run) +".txt"
...
if __name__ == "__main__":
	...
	outputFile = "Normal_3/tripInfo" + str(opt.run) + ".xml"
	logFile = "Normal_3/log" + str(opt.run) + ".xml"
	...
	# to generate the tripInfo files in Normal scenario for run number in the option but for 3 junctions
