...
''' This script runs the simulation in a sybil attack on one junction only '''
...
def run():
	...
	outputVehicle = "Sybil_1/vehicles_around_junction" + junction_ID + str(opt.run) +".txt"
...
if __name__ == "__main__":
	...
	outputFile = "Sybil_1/tripInfo" + str(opt.run) + ".xml"
	logFile = "Sybil_1/log" + str(opt.run) + ".xml"
